                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link href="{{ route('dashboard.index') }}" :active="request()->routeIs('dashboard')">
                        ...
                        @if (Auth::user()->roles == 'ADMIN')
                            ...
                            <x-nav-link href="{{ route('dashboard.table.index') }}" :active="request()->routeIs('dashboard.table.index')">
                                {{ __('Table') }}
                            </x-nav-link>
                            <x-nav-link href="{{ route('index') }}" :active="request()->routeIs('dashboard.my-transaction.index')">
                                {{ __('back to home') }}
                            </x-nav-link>
                        @endif
