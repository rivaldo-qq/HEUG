                 ...
                 <div class="p-6 bg-white border-b border-gray-200">
                    <table class="table-auto w-full">
                        <tbody>
                            ...
                            <tr>
                                <th class="border px-6 py-4 text-right">Jenis Meja</th>
                                <td class="border px-6 py-4">{{ $transaction->tables_id }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="border px-6 py-4 text-right">Booking date</th>
                                <td class="border px-6 py-4">{{ $transaction->book_date }}</td>
                            </tr>
                            <tr>
